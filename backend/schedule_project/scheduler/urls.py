...
urlpatterns = [
    ...
    path(
        "api/activity/update/<int:id>/", views.update_activity, name="update_activity"
    ),
    path(
    ...
    path(
        "api/groupallow/delete/<int:pk>/",
        views.groupallow_delete,
        name="groupallow_delete",
    ),
    path(
        "api/groupallow/delete-all/",
    ...
    path(
        "api/grouptype/delete/<int:pk>/",
        views.grouptype_delete,
        name="grouptype_delete",
    ),
    path(
        "api/grouptype/delete-all/",
    ...
    path(
        "api/roomtype/delete/<int:pk>/", views.roomtype_delete, name="roomtype_delete"
    ),
    path(
        "api/roomtype/delete-all/",
    ...
    path(
        "api/studentgroup/delete/<int:pk>/",
        views.studentgroup_delete,
        name="studentgroup_delete",
    ),
    path(
        "api/studentgroup/delete-all/",
    ...
    path(
        "api/timeslot/delete/<int:pk>/", views.timeslot_delete, name="timeslot_delete"
    ),
    path(
        "api/timeslot/delete-all/",
        views.timeslot_delete_all,
        name="timeslot_delete_all",
    ),
    path(
