...
urlpatterns = [
    ...
    path('api/groupallow/delete-all/', views.groupallow_delete_all, name='groupallow_delete_all'),  # 👈 เพิ่ม
    ...
    path('api/roomtype/delete-all/', views.roomtype_delete_all, name='roomtype_delete_all'),  # ✅
